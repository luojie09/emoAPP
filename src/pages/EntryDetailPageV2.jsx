    ...
    <div className="-mx-4 -mt-5 min-h-screen bg-[#f2f2f7]">
      ...
      <div className="px-4 mt-4">
        <div className="bg-white rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-5">
          <div className="flex items-center gap-3 mb-4">
            <div className={`w-12 h-12 ${moodCardBg} rounded-full flex items-center justify-center text-2xl`}>
              {entry?.emotion?.emoji ?? '🙂'}
            </div>
      ...
      <div className="px-4 mt-4">
        ...
        >
          ...
          <div className="text-[15px] text-[#4A4453] leading-[1.6] tracking-wide whitespace-pre-wrap">
