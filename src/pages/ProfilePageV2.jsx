    ...
    <>
      <div className="px-4 pt-4 pb-4">
        <div className="bg-white rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] px-5 py-4 flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center flex-shrink-0 overflow-hidden">
            {avatarUrl ? (
          ...
          {isGuest ? (
            ...
            <button
              ...
              className="bg-gray-100 hover:bg-gray-200 active:scale-95 text-gray-700 px-4 py-2 rounded-full text-[14px] font-semibold transition-all flex-shrink-0"
            >
              编辑资料
            </button>
          )}
